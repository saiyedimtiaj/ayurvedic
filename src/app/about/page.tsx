...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://www.ayurvedicbyadivashi.com", // ✅ হোমপেজ canonical
    },
  };
};
  ...
  return (
    <div>
      ...
      <div className="mt-5 mb-10 container mx-auto px-2">
        ...
        <p className="mt-6">
          ‘’ আয়ুর্বেদিক বাই আদিবাসী ’’ দেশের অন্যতম একটি নির্ভরযোগ্য প্রতিষ্ঠান,
          যা প্রাচীন আদিবাসী রীতি অনুসরণ করে সম্পূর্ণ প্রাকৃতিক ও বিশুদ্ধ উপাদান
          দিয়ে তৈরি আয়ুর্বেদিক পণ্য গ্রাহকের হাতে পৌঁছে দেওয়া । আমাদের মূল
          লক্ষ্য হলো শতভাগ প্রাকৃতিক ও নিরাপদ পণ্য সরবরাহ করা, যা শরীর ও মনের
          সুস্থতা নিশ্চিত করবে ।
          <br />
          <br />
          আমরা বিশ্বাস করি প্রকৃতির মাঝে সুস্থতার রহস্য লুকিয়ে আছে। তাই, আমাদের
          প্রতিটি পণ্য নির্ভরযোগ্য উৎস থেকে সংগ্রহ করা হয় এবং কোনও ক্ষতিকারক
          রাসায়নিক উপাদান ছাড়া সম্পূর্ণ প্রাকৃতিক উপায়ে প্রস্তুত করা হয়।
          নিরাপদ ও কার্যকর আয়ুর্বেদিক সমাধান নিশ্চিত করাই আমাদের লক্ষ্য।
        </p>
      </div>
      <div className="mt-5 container mb-8 mx-auto px-2">
        <h3 className="font-semibold text-3xl">About Ayurvedic by Adivashi</h3>
        <p className="mt-2 text-gray-500 font-semibold">
        ...
        <p className="mt-6">
          ...
          traditions. Our main goal is to provide 100% natural and safe products
          that ensure the well-being of both body and mind.
          <br />
          <br />

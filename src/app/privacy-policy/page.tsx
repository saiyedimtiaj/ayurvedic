  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-2 md:px-4">
        <h1 className="text-2xl font-semi-bold mt-8 md:text-4xl">Who we are</h1>
        <p className="mt-5 md:text-lg">
          Our website address is: http://naturalsbyrakhi.com
        </p>
        <h1 className="text-2xl font-semi-bold mt-14 md:text-4xl">Comments</h1>
        <p className="mt-5 md:text-lg">
        ...
        <p className="mt-5 md:text-lg">
          ...
          http://naturalsbyrakhi.com/privacy-policy/. After approval of your
          comment, your profile picture is visible to the public in the context
          of your comment.
        </p>
        <h1 className="text-2xl font-semi-bold mt-14 md:text-4xl">Media</h1>
        <p className="mt-5 md:text-lg">
        ...
        <h1 className="text-2xl font-semi-bold mt-14 md:text-4xl">Cookies</h1>
        <p className="mt-5 md:text-lg">
        ...
        <p className="mt-5 md:text-lg mb-10">
